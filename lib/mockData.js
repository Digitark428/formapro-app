...
export const SEED_DOCUMENTS = [
  { id: "d1", modele: "Convention de formation", client: "Atlas Logistique", formation: "Gestion de projet — Méthodes Agiles", date: daysAgo(1), statut: "genere" },
  { id: "d2", modele: "Programme de formation", client: "Atlas Logistique", formation: "Gestion de projet — Méthodes Agiles", date: daysAgo(1), statut: "genere" },
  { id: "d3", modele: "Convocation stagiaire", client: "Saveurs & Co", formation: "Bureautique avancée — Excel expert", date: daysAgo(6), statut: "genere" },
  { id: "d4", modele: "Livret d'accueil", client: "BuildR", formation: "Management & Leadership d'équipe", date: daysAgo(5), statut: "genere" },
  { id: "d5", modele: "Règlement intérieur", client: "BuildR", formation: "Management & Leadership d'équipe", date: daysAgo(5), statut: "genere" },
];
